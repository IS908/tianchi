...
public class OrderConsumer {
    public static DefaultMQPushConsumer[] getConsumer(final BlockingQueue<OrderMessage> tbQueue, final BlockingQueue<OrderMessage> queue) throws MQClientException {
        DefaultMQPushConsumer tb_consumer = OrderConsumer.getOrderConsumerByTopic(RaceConfig.MqTaobaoTradeTopic, tbQueue);
    ...
    private static DefaultMQPushConsumer getOrderConsumerByTopic(String topic, final BlockingQueue<OrderMessage> queue) throws MQClientException {
        ...
        tm_consumer.setNamesrvAddr(RaceConfig.mqIP);
